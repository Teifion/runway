...
class WordyProfile(Base):
    ...
    user          = Column(Integer, ForeignKey("runway_users.id"), nullable=False, index=True, primary_key=True)
...
class WordyGame(Base):
    ...
    current_player = Column(Integer, ForeignKey("runway_users.id"), nullable=False, index=True)
    ...
    winner = Column(Integer, ForeignKey("runway_users.id"), nullable=True)
...
class WordyMove(Base):
    ...
    player        = Column(Integer, ForeignKey("runway_users.id"), nullable=False, index=True)
